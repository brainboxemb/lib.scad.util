...
| Phase | Duration |
| --- | ---: |
| Preflight + execution plan | 11.088 s |
| Cache restore | 372 ms |
| Runtime pull | 24.147 s |
| Capability materialization | 5.650 s |
| Cache save | 761 ms |
| Validation + finishing | 565 ms |
| Snapshot preparation | 2 ms |
| **Total to prepared snapshot** | **42.650 s** |
